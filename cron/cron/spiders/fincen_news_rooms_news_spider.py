...
class FincenNewsRoomsNewsSpider(Spider):
    name = "fincen_news_rooms_news"
    ...
    def parse(self, response):
        ...
        for scrapItem in scrapItems:
            ...
            datetime_str = scrapItem.xpath('span[@class="views-field views-field-field-date-release"]/span[@class="field-content"]/time/text()').extract()[0]
