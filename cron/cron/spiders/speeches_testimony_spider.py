...
class SpeechesTestimonySpider(Spider):
    name = "speesches_testimony"
    ...
    def parse(self, response):
        ...
        for scrapItem in scrapItems:
            ...
            item['headline'] = scrapItem.xpath('td[@headers="view-title-table-column"]/a/text()').extract()[0]
            item['article_link'] = 'https://www.cftc.gov' + scrapItem.xpath('td[@headers="view-title-table-column"]/a/@href').extract()[0]
